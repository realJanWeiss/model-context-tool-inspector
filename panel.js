...
// Request the tool list from the inspected tab's content script.
(async () => {
  try {
...
// content.js broadcasts via chrome.runtime.sendMessage so both background and
// this panel receive the message. We filter to the inspected tab only.
...
executeBtn.onclick = async () => {
  ...
  toolResults.textContent = await chrome.tabs.sendMessage(tabId, {
